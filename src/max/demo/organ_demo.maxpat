...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 150.0, 60.0, 20.0 ],
									"style" : "",
									"text" : "threshold"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 120.0, 90.0, 20.0 ],
									"style" : "",
									"text" : "rescale to 0.-1."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 210.0, 60.0, 132.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 15.0, 60.0, 126.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 150.0, 90.0, 22.0 ],
									"style" : "",
									"text" : "vexpr $f1 > 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 210.0, 210.0, 160.0, 35.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 210.0, 180.0, 63.0, 22.0 ],
									"style" : "",
									"text" : "zl slice 18"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 120.0, 98.0, 22.0 ],
									"style" : "",
									"text" : "vexpr ($f1 / 255)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 210.0, 90.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "jit.spill"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 150.0, 90.0, 22.0 ],
									"style" : "",
									"text" : "vexpr $f1 > 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 15.0, 210.0, 165.0, 35.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 180.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "zl slice 8"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 225.0, 15.0, 242.0, 74.0 ],
									"style" : "",
									"text" : "Grabbing this from the solenoid output for now to avoid multiple readbacks. Values are on/off, though... might be worth taking it directly from the motion_image texture to get some slide."
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "vexpr $f1 * 255. @scalarmode 255"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 15.0, 15.0, 171.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 105.0, 75.0, 22.0 ],
									"style" : "",
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 180.0, 135.0, 35.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 225.0, 135.0, 75.0, 37.0 ],
									"style" : "",
									"text" : "output scaling"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 180.0, 179.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 15.0, 315.0, 294.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 15.0, 225.0, 165.0, 75.0 ],
									"presentation" : 1,
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 75.166664, 48.0, 24.5, 48.0 ],
									"source" : [ "obj-2", 1 ]
								}
...
,
		...
		"parameters" : 		{
			...
			"obj-6::obj-85" : [ "multislider[2]", "multislider", 0 ],
